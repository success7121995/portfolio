...
?>
  ...
  <div id="about-me" class="fade-in-section md:mt-5">
    <section class="w-[85%] max-w-[1000px] min-w-[375px] mx-auto py-[50px]">
      ...
      <article class="w-[93%] mx-auto md:w-[90%]">
  ...
  <div id="work-experience" class="w-screen bg-[#FAF7F0] fade-in-section">
    <section class="flex flex-col justify-center item-center py-10 w-[85%] max-w-[1000px] mx-auto min-h-[250px] min-w-[375px] ">
